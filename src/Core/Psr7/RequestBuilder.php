...
class RequestBuilder
{
    ...
    public static function buildRequest($url = null, $method = null, $headers = null, $body = null)
    {
        if (class_exists(LaminasDiactorosRequest::class)) {
            $request = self::requestFromLaminasDiactoros($url, $method, $headers, $body);
            ...
            throw new Exception(
                ...
                . '"Laminasframework/Laminas-diactoros" or "guzzlehttp/psr7"'
            );
        }
    ...
    protected static function requestFromLaminasDiactoros($url = null, $method = null, $headers = null, $body = null)
    {
        if (is_string($body)) {
            $bodyStr = $body;
            $body = new LaminasDiactorosStream('php://temp', 'r+');
            $body->write($bodyStr);
        }

        return new LaminasDiactorosRequest(
            $url ? (string)  $url : '',
            $method ? $method : 'GET',
            $body ? $body : 'php://temp',
            $headers ? $headers : []
